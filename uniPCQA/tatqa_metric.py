...
def extract_gold_answers(qa_annotation):
    ...
    #req_clari = qa_annotation['req_clari']
    gold_answers = []
    #if req_clari:
    #    gold_answers.append(answer_content)
    #elif answer_type in ['multi-span', 'span'] and not req_clari: # list
    if answer_type in ['multi-span', 'span', 'question']:
